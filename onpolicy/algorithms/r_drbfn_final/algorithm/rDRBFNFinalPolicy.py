"""R_DRBFN_FINAL Policy: identical architecture to v1.

v_final = v1 + n-step Q_tot target (Trainer-level change only).
Networks (BFN + Q_i + Q_tot) reused from v1.
"""
import torch
...
class R_DRBFNFinalPolicy(R_MAPPOPolicy):
    """v_final Policy: same networks as v1, Trainer changes Q_tot to n-step."""
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, num_agents,
        ...
        # v_final new: n-step horizon for Q_tot target
